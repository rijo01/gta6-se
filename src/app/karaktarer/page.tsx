      ...
      <main style={{ paddingTop: '56px' }}>
        <section className="category-hero" style={{ borderBottom: '1px solid rgba(155,47,255,0.1)' }}>
          <div style={{
            ...
            background: 'radial-gradient(ellipse, rgba(155,47,255,0.07) 0%, transparent 70%)',
          ...
          <div className="max-w-6xl mx-auto" style={{ position: 'relative', zIndex: 1 }}>
            ...
            <p style={{ color: '#6A5E70', fontSize: '0.95rem', marginTop: '0.75rem', maxWidth: '500px' }}>
              Jason, Lucia och alla karaktärer som ger Vice City liv
            </p>
            <span style={{ fontFamily: 'Barlow Condensed, sans-serif', fontWeight: 700, fontSize: '0.65rem', letterSpacing: '0.15em', textTransform: 'uppercase', color: '#9B2FFF', display: 'block', marginTop: '1rem', opacity: 0.6 }}>
              {articles.length} karaktärer
            </span>
          </div>
        </section>
